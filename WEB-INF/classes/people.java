...
public class people extends HttpServlet 
{
    ...
    {        
		...
		query = "select distinct PersonId, Name from person";
		
		out.println("<html><head><title>People Table Report</title>");	 
		out.println("</head><body>");
		
		out.print( "<br /><b><center><font color=\"RED\"><H2>People Table Report test</H2></font>");
        ...
        out.println("<td align = \"justify\"><font face =\"times new roman\"  size=\"4pt\">Person Name</td>");
        out.println("</tr>");
		try 
		{ 
            while(result.next()) 
